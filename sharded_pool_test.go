...
// Concurrency tests for the per-P sharded module pool (procPin-indexed
// free-list with cross-shard stealing). Combined with the persistent
// per-module scratch buffer, these stress module ownership and scratch
// aliasing under many goroutines. Run under `go test -race`.
